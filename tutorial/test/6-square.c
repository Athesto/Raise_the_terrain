...
void draw_squarerow(SDL_Instance instance, int s_len);
int main(void)
{
...
void draw_squarerow(SDL_Instance instance, int m_len)
{
	...
	SDL_RenderDrawLine(instance.renderer, o.x, o.y + o.len, pend.x, pend.y); /* x */
